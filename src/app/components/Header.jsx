    ...
    >
      <div className="flex items-center justify-between w-full px-4 sm:px-8 py-5 text-[#3F2010]">
        ...
        <div className="relative md:block hidden w-1/3">
          <input
            className="border border-[#4B241780] bg-[#FBF5EB] rounded-full px-4 py-2 w-96 placeholder:text-[#6E5A4A]"
            type="search"
            placeholder="Search products and categories"
          />
          <IoIosSearch className="absolute right-18 top-3" size={20} />
        </div>

        <div
          className="md:flex hidden items-center gap-1 relative cursor-pointer"
        ...
        {/* Right - Icons */}
        <div className="hidden md:flex items-center md:gap-5 lg:text-sm md:text-xs lg:gap-10">
          {/* Account */}
          <div
      ...
      >
        <div
          onClick={hideNavar}
          className="flex flex-col items-center space-y-10 h-screen py-18 px-8 gap-4 bg-[#F0E0D0]"
        >
